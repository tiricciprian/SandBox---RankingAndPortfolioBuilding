...
if(workingWith == "S&P500")
{
  ...
  symbolsList <- c( "SBICARD.NS",	"GODREJPROP.BO",	"BEL.BO",	"BANKBARODA.BO",	"MPHASIS.BO",	"FEDERALBNK.BO",	"TRENT.BO",	"IRCTC.NS",	"ADANIPOWER.BO",	"TATAELXSI.BO",	"INDHOTEL.BO",	"JSWSTEEL.BO",	"NAUKRI.BO",	"BRITANNIA.BO",	"TATASTEEL.BO",	"HINDALCO.BO",	"EICHERMOT.BO",	"TATACONSUM.NS",	"TATAPOWER.BO",	"ONGC.BO",	"SBIN.BO",	"GRASIM.BO",	"HDFC.BO",	"HDFCBANK.BO",	"ASIANPAINT.BO",	"UPL.BO",	"ZEEL.BO",	"CHOLAFIN.BO",	"TECHM.BO",	"DRREDDY.BO",	"GODREJCP.BO",	"CIPLA.BO",	"SUNPHARMA.BO",	"INFY.BO",	"ASIANPAINT.BO",	"ASHOKLEY.BO",	"NESTLEIND.BO",	"HCLTECH.BO",	"DIVISLAB.BO",	"TCS.BO",	"APOLLOHOSP.BO",	"LUPIN.BO",	"BAJAJFINSV.BO",	"ICICIBANK.BO",	"TATAMOTORS.BO",	"BAJAJHLDNG.BO",	"VEDL.BO",	"AMBUJACEM.BO",	"WIPRO.BO",	"HINDUNILVR.BO",	"BHARATFORG.BO",	"HAVELLS.BO",	"VOLTAS.BO",	"SHREECEM.BO",	"SIEMENS.BO",	"TITAN.BO",	"RELIANCE.BO",	"SRTRANSFIN.BO",	"KOTAKBANK.BO",	"DABUR.BO",	"M&M.BO",	"PIDILITIND.BO",	"ACC.BO",	"MARICO.BO",	"BAJFINANCE.BO",	"ADANIENT.BO",	"LT.BO",	"ULTRACEMCO.BO",	"MFSL.BO",	"BHARTIARTL.BO",	"SRF.BO",	"DLF.BO",	"PAGEIND.BO",	"ADANIPORTS.BO",	"TATAMTRDVR.BO",	"PIIND.BO",	"JUBLFOOD.BO",	"INDIGO.BO",	"CROMPTON.BO",	"ICICIPRULI.BO",	"LT.BO",	"DMART.BO",	"AUBANK.BO",	"SBILIFE.BO",	"INDUSINDBK.BO",	"BPCL.BO",	"IOC.BO",	"GAIL.BO",	"HEROMOTOCO.BO",	"MARUTI.BO",	"ITC.BO",	"COLPAL.BO",	"AXISBANK.BO",	"NTPC.BO",	"POWERGRID.BO",	"BAJAJ-AUTO.BO",	"COALINDIA.BO",	"HDFCLIFE.BO",	"ICICIGI.BO",	"BANDHANBNK.NS")
